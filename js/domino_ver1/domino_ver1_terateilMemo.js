$(function(){
  ...
  */
  ...
  // OK
  //////  terateil question
  // 全て t_id=1になり、全て同時に動く
  // 途中でt_id=t_id+1 にすると全て3になり、2が動かない
  ...
  $("#t1").click(function(){
    ...
    console.log(t_id);
    t_id = t_id+1;   // 全て3になり、2が動かない
    $("#t"+t_id).on("transitionend",function(){  //2
      t_id = t_id+1;
      console.log(t_id);
      $("#t"+t_id).css({  //3
        transform:angle
